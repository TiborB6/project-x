    ...
    <>
      <div className="section-one">
        <div className="description">
          ...
          <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Esse deserunt dicta sit delectus numquam nisi quidem consequuntur necessitatibus error molestiae dignissimos, iusto quasi quae expedita, ea, quis ex est. Porro!</p>
        </div>
        <div className="description">
        <svg xmlns="http://www.w3.org/2000/svg" height="48" viewBox="0 -960 960 960" width="48">
          ...
          <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Pariatur quis unde explicabo veniam assumenda totam ab repudiandae numquam repellat voluptates fuga laborum soluta nam earum, eveniet consequatur modi facilis nostrum.</p>
        </div>
        <div className="description">
          <svg xmlns="http://www.w3.org/2000/svg" height="48" viewBox="0 -960 960 960" width="48">
          ...
          <h1>All Inclusive</h1>
          <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Harum ipsa blanditiis ducimus tempora, incidunt consequatur enim est, aspernatur beatae numquam, maxime molestias eos quos. Possimus, ratione! Soluta sed pariatur aliquam.</p>
        </div>
      </div>
    </>
  )
